...
public:
    ...
    virtual bool isStalemate(const Piece::board_type& board, Color color, std::optional<Move> lastMove) const = 0;
...
public:
    ...
    virtual bool isStalemate(const Piece::board_type& board, Color color, std::optional<Move> lastMove) const override;
